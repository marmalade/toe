...
IW_CLASS_FACTORY(Ctoe3DModel);
//This macro is required within some source file for every class derived from CIwManaged. It implements essential functionality
IW_MANAGED_IMPLEMENT(Ctoe3DModel);

//Constructor
Ctoe3DModel::Ctoe3DModel()
{
...
void Ctoe3DModel::Render(CtoeRenderContext*)
{
...
bool	Ctoe3DModel::ParseAttribute(CIwTextParserITX* pParser, const char* pAttrName)
{
